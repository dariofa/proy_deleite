				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-7">
								<div class="form">
				{!! Form::open(['route' => ['admin.cajas.update',$cajas->id], 'method' => 'post']) !!}

                {!! Form::label('nombre','Nombre') !!}
                {!! Form::text('nombre',$cajas->nombre,['class'=>'form-control']) !!}

                {!! Form::label('saldo_actual','Cantidad') !!}
                {!! Form::text('saldo_actual',$cajas->saldo_actual,['class'=>'form-control']) !!}
